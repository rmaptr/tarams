...
SECRET_KEY = 'django-insecure-j9*5oaqu^$c2p47hdkhar7&lkx&seb8coy%@0m2!ah0ls9m9n&'
...
# --- KONFIGURASI DRF (Agar Backend Bisa Baca Token) ---
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'rest_framework.authentication.TokenAuthentication',  # <--- INI KUNCINYA
